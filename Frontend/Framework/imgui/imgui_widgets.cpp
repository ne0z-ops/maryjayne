...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    // Make checkbox slightly larger and perfectly square
    const float square_size = label_size.y + style.FramePadding.y * 2.f;
    const ImRect check_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(square_size, square_size));
    ...
    const ImColor borderColor(10, 10, 10, 255);
    const ImColor topColor(52, 52, 52, 255);
    const ImColor bottomColor(68, 68, 68, 255);
    const ImColor topColorHovered(0, 128, 0, 255);
    const ImColor bottomColorHovered(0, 128, 0, 255);
    const ImColor checkedTopColor(34, 139, 34, 255);
    const ImColor checkedBottomColor(0, 128, 0, 255);


    // Draw checkbox with exact padding of 3px
    if (*v) {
        window->DrawList->AddRectFilledMultiColor(
            check_bb.Min + ImVec2(3, 3),
            check_bb.Max - ImVec2(3, 3),
            checkedTopColor,
            checkedTopColor,
            checkedBottomColor,
            checkedBottomColor
...
bool ImGui::Combo(const char* label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items)
{
    ...
    // Style customization
    ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(24 / 255.0f, 24 / 255.0f, 24 / 255.0f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(32 / 255.0f, 32 / 255.0f, 32 / 255.0f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(140 / 255.0f, 70 / 255.0f, 190 / 255.0f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_PopupBg, ImVec4(12 / 255.0f, 12 / 255.0f, 12 / 255.0f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(200 / 255.0f, 200 / 255.0f, 200 / 255.0f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_HeaderHovered, ImVec4(140 / 255.0f, 70 / 255.0f, 190 / 255.0f, 0.7f));
    ImGui::PushStyleColor(ImGuiCol_HeaderActive, ImVec4(140 / 255.0f, 70 / 255.0f, 190 / 255.0f, 1.0f));
    ...
    for (int i = 0; i < items_count; i++)
    {
        ...
        if (item_selected)
            ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(140 / 255.0f, 70 / 255.0f, 190 / 255.0f, 0.9f));
